...
/*
	...
	- locations_js.php - Used for the autocomplete on the destination search
	- locations.php - Not used?
	- countries.php - Used to validate search input and convert Country names into Codes for the API
	- dests_count2loc.php - Used on the destinations page, to list the locations for a given Country
...
class CronCacheLocations extends MainController
{
	...
	public function run() {
		...
		$result = $this->call_tourcms_api('list_tour_locations', $channel_id);
	...
	{
	    $return = "/things-to-do/".$this->simple_tidy_url($country)."/";

	    if ($location != "") {
	        $return .= $this->simple_tidy_url($location)."/";
	    }

	    return $return;
	}

	public function simple_tidy_url($name)
	{
