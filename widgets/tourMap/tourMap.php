...
class tourMap extends WP_Widget {
	function __construct() {
		parent::__construct(false, __('Legacy Tour Map', 'gray-line-licensee-wordpress-tourcms-plugin'), array('description' => __('Displays the starting point stored in TourCMS using Google Maps. Only visible on Tour/Hotel pages.', 'gray-line-licensee-wordpress-tourcms-plugin')));	
	}
...
add_action('widgets_init', function( $output ) { return register_widget("tourMap"); } );
?>